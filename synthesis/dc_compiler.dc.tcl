...
set netlist_search_path "/home/a19357_asu/asap7_rundir/525_lib/GCN"
set netlist_search_path_2 "/home/a19357_asu/asap7_rundir/525_lib/GCN/RTL_Simulation_3"
# NETLIST NAME

set netlist_name "GCN.sv"
set netlist_name1 "Transformation_block.sv"
set netlist_name16 "Transformation_FSM.sv"
set netlist_name2 "Vector_Multiplier.sv"
set netlist_name3 "WEIGHT_COUNTER.sv"
set netlist_name4 "fm_wm_ADDRESS.sv"
set netlist_name5 "FEATURE_COUNTER.sv"
set netlist_name6 "Scratch_Pad.sv"

set netlist_name7 "Combination_block.sv"
set netlist_name8 "COO_ADJ.sv"
set netlist_name9 "counter.sv"
set netlist_name10 "ADJ_FM_WM.sv"

set netlist_name11 "ARG_MAX_block.sv"
set netlist_name12 "ARG_MAX.sv"
set netlist_name13 "ARG_MAX_COMB.sv"
set netlist_name14 "Matrix_FM_WM_ADJ_Memory.sv"
set netlist_name15 "Matrix_FM_WM_Memory.sv"
...
analyze -format sverilog $netlist_search_path_2/$netlist_name1
analyze -format sverilog $netlist_search_path_2/$netlist_name2
analyze -format sverilog $netlist_search_path_2/$netlist_name3
analyze -format sverilog $netlist_search_path_2/$netlist_name4
analyze -format sverilog $netlist_search_path_2/$netlist_name5
analyze -format sverilog $netlist_search_path/$netlist_name6
analyze -format sverilog $netlist_search_path/$netlist_name7
analyze -format sverilog $netlist_search_path/$netlist_name8
analyze -format sverilog $netlist_search_path/$netlist_name9
analyze -format sverilog $netlist_search_path/$netlist_name10
analyze -format sverilog $netlist_search_path/$netlist_name11
analyze -format sverilog $netlist_search_path/$netlist_name12
analyze -format sverilog $netlist_search_path/$netlist_name13
analyze -format sverilog $netlist_search_path/$netlist_name14
analyze -format sverilog $netlist_search_path/$netlist_name15
analyze -format sverilog $netlist_search_path_2/$netlist_name16
